...
def main_5fold_cv():
    ...
    ap.add_argument("--outdir", default="outputs_ablation4_full_graph")
    ...
    # ABLATION 4: Full graph — default to fully connected adjacency matrix.
    # Tests whether the Reactome prior matters, or the model can learn from data alone.
    ap.add_argument("--use_full_graph", action='store_true', default=True,
