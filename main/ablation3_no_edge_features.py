...
class PathwayGraphTransformer(nn.Module):
    ...
    def forward(self, mut: torch.Tensor, cnv: torch.Tensor, return_extras: bool = False, 
        ...
        # ABLATION 3: No edge features — pass edge_feat=None to all transformer blocks.
        # This removes edge-conditioned attention bias to test whether it matters.
        edge_feat = None
...
def main_5fold_cv():
    ...
    ap.add_argument("--outdir", default="outputs_ablation3_no_edge_features")
