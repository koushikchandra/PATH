...
def main_5fold_cv():
    ...
    for fold_data in folds:
        ...
        # Extract pathway-pathway interaction matrix from attention
...
# FINAL RESULTS
    ...
    # Aggregate pathway-pathway attention across folds
    if all_fold_attention:
        ...
        print("Warning: No attention matrices collected; aggregate pathway interaction not saved.")
